...
function CheckOut() {
    ...
    const { mutate: checkout, isPending: isCheckOut, isError: isCheckOutError } = useCheckOut();
                    ...
                    <Paper sx={{ p: 3, borderRadius: 2 }}>
                        ...
                        <FormControl fullWidth>
                            ...
                            >
                                ...
                                <MenuItem value="Visa">{t("Credit Card")}</MenuItem>
...
function Row({ label, value, bold }) {
    return (
        <Box sx={{ display: "flex", justifyContent: "space-between" }}>
            <Typography sx={{ fontWeight: bold ? 800 : 600 }}>
                {label}
            </Typography>
            <Typography sx={{ fontWeight: bold ? 900 : 700 }}>
                {value}
            </Typography>
        </Box>
    );
